...
> | `docker compose` + `-f docker-compose.vps.yml` (a public server) | `https://<your host>` | `SERVER_NAME` and `ALLOWED_ORIGIN`, both in `.env` — see [`infra/README.md`](infra/README.md) |
>
