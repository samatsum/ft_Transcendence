...
作業の分割・依存・引き継ぎは [チーム分担計画](./md_files/ja/チーム体制.html) を参照。
...
それを WS でつなぐサーバと画面がまだありません。詳細は [チーム分担計画](./md_files/ja/チーム体制.html)。
