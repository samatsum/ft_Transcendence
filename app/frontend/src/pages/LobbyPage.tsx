...
const STATUS_LABEL: Record<string, { text: string; cls: string }> = {
	...
	open: { text: '接続済み', cls: 'text-accent-bright' },
	reconnecting: { text: '再接続中…', cls: 'text-warning-bright' },
	closed: { text: '切断', cls: 'text-danger-bright' },
};
		...
		<div className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-10">
			...
			{room && (
				<Card className="flex flex-col gap-3">
					...
					<div className="rounded-md border border-line bg-surface-low/40 p-4">
						...
						{rules.settingsError && !rules.settingsError.startsWith('先取点') && (
							<p className="text-body mt-2 text-danger-bright" role="alert">
								{rules.settingsError}
							</p>
						)}
					</div>
