	...
	return (
		<article className="mx-auto flex max-w-3xl flex-col gap-8 px-4 py-12 text-fg-secondary">
			<header className="flex flex-col gap-2">
				<h1 className="text-heading-lg">Terms of Service</h1>
				<p className="text-body text-fg-subtle">最終更新: 2026-08-21</p>
			</header>

			<section className="flex flex-col gap-2">
				<h2 className="text-heading-sm text-fg">サービスの説明</h2>
			...
			<section className="flex flex-col gap-2">
				<h2 className="text-heading-sm text-fg">禁止事項</h2>
				<p className="text-body leading-relaxed text-fg-secondary">
			...
			<section className="flex flex-col gap-2">
				<h2 className="text-heading-sm text-fg">保証の否認</h2>
				<p className="text-body leading-relaxed text-fg-secondary">
			...
			<section className="flex flex-col gap-2">
				<h2 className="text-heading-sm text-fg">教育プロジェクトについて</h2>
				<p className="text-body leading-relaxed text-fg-secondary">
