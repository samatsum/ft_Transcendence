...
## Project status (implementation as of 2026-07-30, plus three later dated exceptions below (B-02, G-11, G-12); reconciled against `origin/main` @ `7df11c9`; module lineup as of the 2026-08-08 D-19 revision)
...
- **Server** (B-/I-series): I-01, **B-02** and **B-03** (both 2026-08-09), B-09, B-10, B-11, B-12, B-14 complete (**8**); **B-08 is core-complete, not complete** — it still needs the real cookie auth from B-04/B-05, so backlog.md counts it separately. B-08–B-12 were
  built ahead of schedule against `ALLOW_DEV_AUTH` and still need to integrate with real cookie
  auth (**B-04–B-05**, not yet done). B-03 landed the Prisma schema, but **nothing reads or writes it yet** — B-04 is its first consumer. **B-17 (spectator server side), I-15, I-16** are also outstanding.
  **B-06, B-07 and B-13 were dropped on 2026-08-08** by the D-19 module revision. CI is green on all jobs.
- **Frontend** (F-/GV-series): F-03, F-04, F-05, F-11, GV-08, and GV-12 are tracked in GitHub Issues and
  Projects. **F-09 and F-10 were dropped on 2026-08-08**, and **GV-12 was promoted from reserve to
  required** by the same revision. **Gate 2** is the 2-browser, 2v2 RSP end-to-end acceptance gate and
  converges F-05 with GV-08.
...
started** — the new team kicked off 2026-08-08 and role assignment took effect at the 2026-08-23
meeting — and the project is now a 6-person team, meeting the subject's 4–5 person requirement:
...
tvaroux), and samatsum stepped back to a Supporter role. (mamiyaza was briefly recorded as a second
Supporter on 2026-08-31; that was wrong — mamiyaza confirmed by DM on 2026-08-23 that they had left
the team, and the headcount was corrected back to 6 on 2026-09-09.) Full roster with
