...
## 5. ゲート2 判定スコープの食い違い（提案）

| 資料 | ゲート2 に含むもの |
|---|---|
| [⑥ チーム分担計画](../02_設計書/6-チーム分担計画.md) §5.1 | Day3 終わり。日割り上 W-12 は Day4 |
| [⑤ バックログ](../02_設計書/5-バックログ.md) ゲート表 | W-08〜**W-12** / F-05〜F-08 |

**提案（PM が Day1 朝に決める）**:

- **案α（推奨）**: ゲート2 = 「2ブラウザで最後まで遊べる」。切断/再接続（W-12）はゲート2.5 / Day4  
- **案β**: W-12 の最小（切断即AI）だけ Day3 に入れる  

決めたら **⑤と⑥の文言を同じ一文に揃える**。揃えぬまま日次すると、完了定義が割れる。
